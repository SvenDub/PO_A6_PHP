...
$resultaat = $db->bestellingstatus_wijzigen( $bestellingnummer, 1 );

if ($resultaat == true) {
	print ("Bestellingstatus is gewijzigd, de ober komt het product zometeen ophalen. ") ;
} else {
	print ("Het is niet gelukt om de status te wijzigen") ;
}
