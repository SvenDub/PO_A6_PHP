...
<body>
	<div id="page" class="container">
		...
		<div id="main">
			...
			print ("<tr><td>maand 3 tot 6 geleden</td><td>&euro; $omzet_3maanden</td><td><img src='blok.png'  style='float:left;' width='$breedte*$omzet_6maanden' height='40'></td></tr>") ;
			print ("<tr><td>maand 6 tot 9 geleden</td><td>&euro; $omzet_3maanden</td><td><img src='blok.png'  style='float:left;' width='$breedte*$omzet_9maanden' height='40'></td></tr>") ;
			print ("<tr><td>maand 9 tot 12 geleden</td><td>&euro; $omzet_3maanden</td><td><img src='blok.png' style='float:left;' width='$breedte*$omzet_12maanden' height='40'></td></tr>") ;
			// De variablee worden dan weergegeven doormiddel van een printscript, de breedte varieert doordat de waarde van de variabelen anders zijn.
			?>
			</table>
